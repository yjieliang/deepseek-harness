...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-kb': { kind: 'indirect', reason: 'The panel reads and writes files through the kb Remote namespace; the model-facing kb_* tools live in the knowledge-base agent preset and own every model-visible effect.' },
  'packages/host/kb': { kind: 'indirect', reason: 'The host engine and Remote namespace are the panel\'s data plane; the model-facing kb_* tools live in the knowledge-base agent preset and own every model-visible effect.' },
