...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  referenceAppearances: 'client-side interface-typed browser service — packages/client/ui-input-trigger/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  KbCreateDirRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbCreateDirResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbCreateRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbCreateResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbDeleteRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbDeleteResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbDirsResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbEmptyRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbEmptyResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbGetRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbGetResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbImagesResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbLinksResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbListRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbListResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbMoveRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbMoveResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbPurgeRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbPurgeResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRenameRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRenameResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRenameDirRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRenameDirResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbResolveRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbResolveResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRestoreRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbRestoreResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbSaveRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbSaveResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbSearchRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbSearchResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbStatsResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbTagsResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbToolSearchRequest: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
  KbTrashResult: 'knowledge-base wire vocabulary is owned by packages/host/kb/src/types.ts',
}
