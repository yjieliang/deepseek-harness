...
export const zh = {
  ...
  'warning.imagesDegraded': '已切换模型；该模型不支持图片输入，会话中的图片将以占位文本替代',
  'action.reload': '重新加载',
...
export const en = {
  ...
  'warning.imagesDegraded': 'Model switched; it does not accept image input, so session images are replaced with placeholder text',
