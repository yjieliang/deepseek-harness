...
export const en = {
  ...
  imageInput: 'Accept image input',
  imageInputHint: 'Enable only for models that actually accept images; image requests to a text-only model fail.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  imageInput: '支持图片输入',
  imageInputHint: '仅为实际支持图片的模型启用；向纯文本模型发送图片会失败。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
