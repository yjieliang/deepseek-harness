...
import { DetailsFilePreview } from './DetailsFilePreview.tsx'
...
export function DetailsPanel({
  ...
  // A file preview is the whole panel body; the title is the absolute path.
  const previewing = previewFile !== null
    ...
    <div className={css.root}>
      <div className={css.header}>
        <div className={css.title}>
          {previewing
            ? previewFile?.path ?? t('filePreview.title')
      ...
      <div className={css.body}>
        {previewing && previewFile !== null
          ? (
            <DetailsFilePreview
              path={previewFile.path}
              lang={previewFile.lang}
