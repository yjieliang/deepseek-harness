...
export const zh = {
  ...
  'filePreview.loadFailed': '无法读取此文件',
  'filePreview.truncated': '文件过大，仅显示前 {size}',
  'filePreview.openInSystem': '在系统默认应用中打开',
  'filePreview.source': '源码',
  'filePreview.rendered': '渲染预览',
...
export const en = {
  ...
  'chat.navUp': 'Jump to previous message',
  'chat.navDown': 'Jump to next message',
  ...
  'filePreview.loadFailed': 'Couldn’t read this file',
  'filePreview.truncated': 'File is large; showing the first {size}',
  'filePreview.openInSystem': 'Open in the system default app',
  'filePreview.source': 'Source',
  'filePreview.rendered': 'Render preview',
