  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Remove a session from the registry-global archive set so grouping surfaces show it again at its retained slot. Idempotent for an id already unarchived.',
