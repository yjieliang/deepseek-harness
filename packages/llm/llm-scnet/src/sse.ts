 ...
 * SCNet protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module dsh-llm-scnet/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@deepseek-ai/dsh-llm'

/** The terminal payload SCNet (and OpenAI) send after the last chunk. */
