/**
 * Translate SCNet SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate SCNet wire chunks into the harness `StreamChunk` protocol.
 * @module dsh-llm-scnet/translate
 */
...
/**
 * Map wire usage fields. The OpenAI-compatible `prompt_tokens` INCLUDES cache hits
