/**
 * SCNet chat-completions wire format (OpenAI-compatible). Types only.
 *
 * Source of truth: the platform API docs at
 * <https://www.scnet.cn/ac/openapi/doc/2.0/moduleapi/api/chat.html>,
 * cross-checked against the DeepSeek chat-completions protocol (thinking mode,
 * tool calls, usage) that the SCNet endpoint exposes for `DeepSeek-V4-Flash-0731`.
 *
 * @module dsh-llm-scnet/types
 */
