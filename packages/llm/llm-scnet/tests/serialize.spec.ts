...
function request(overrides: Partial<GenerateOptions> = {}): GenerateOptions {
  return { provider: 'scnet', model: 'DeepSeek-V4-Flash-0731', messages: [], ...overrides }
}
...
describe('serializeRequest', () => {
  ...
  it.each(['high', 'max'] as const)('maps adapter-default thinking and request effort %s', (effort) => {
  ...
  it('rejects an effort outside the SCNet capability', () => {
