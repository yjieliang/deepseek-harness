...
import {
  ...
  hostPickDirectoryRequestSchema, hostReadFileRequestSchema,
  hostSetDshHomeRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.setDshHome': { schema: hostSetDshHomeRequestSchema, invoke: (api, r) => api.host.setDshHome(r) },
