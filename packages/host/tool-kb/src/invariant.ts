...
const PACKAGE_NAME = '@deepseek-ai/dsh-tool-kb'

/** Cordis companion plugin name. */
export const name = 'tool-kb-invariant'
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants']

/**
 * No runtime invariant: this model-facing adapter has no independent lifecycle
 * stream; execution relations are owned by the knowledge-base service it calls.
 */
